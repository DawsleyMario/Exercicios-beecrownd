...
Os participantes devem cheirar, saborear e avaliar a amostra, de modo a identificar o tipo de chá, 
que pode ser: (1) o chá branco; (2) chá verde; (3) chá preto; ou (4) chá de ervas. 
...
https://judge.beecrowd.com/pt/problems/view/200

chá_correto = int(input())
respostas = list(map(int, input().split()))
print(respostas.count(chá_correto))
